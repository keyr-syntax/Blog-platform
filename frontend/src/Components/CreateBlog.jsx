...
function CreateBlog() {
  ...
  const handleCreateBlog = async (e) => {
    ...
    const token = localStorage.getItem("token");
    try {
      const data = await fetch(`${BACKEND_API}/api/blog/createBlog`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
    ...
    <>
      <Container style={{ maxWidth: "1000px", marginTop: "70px" }}>
        <Form
          ...
          className="mb-5"
        >
          <h4 className="text-center text-light my-4">Create new blog</h4>
          <Form.Group className="mb-3" controlId="Add a header image">
            <Form.Label
              style={{ fontWeight: "bold", fontSize: "20px" }}
              className="text-light"
            >
              Add a header image for your blog
            </Form.Label>
          ...
          <Form.Group className="mb-3" controlId="tag">
            <Form.Label
              ...
              className="text-light"
            >
              Add Tags ( You can add five tags )
            </Form.Label>
            <div
              style={{
                display: "flex",
          ...
          <Form.Group className="mb-3" controlId="description">
            ...
            <Editor
              ...
              init={{
                ...
                toolbar:
                  " undo redo restoredraft preview paste clipboardCustomButtons  | blocks fontfamily fontsize | fullscreen | bold italic underline strikethrough | link image media table mergetags | addcomment showcomments | spellcheckdialog a11ycheck typography | align lineheight | checklist numlist bullist indent outdent | emoticons charmap | removeformat codesample code ltr rtl /my-styles.css insertdatetime ",
            ...
            <Form.Group className="mb-3" controlId="blog scheduler">
              ...
              <Form.Control
                ...
                onChange={(event) => {
                  ...
                  setIsScheduled(true);
                  console.log("scheduledFor", utcDate);
                }}
              />
            </Form.Group>
            <Button
